    ...
    <section className="py-24 px-6 bg-[#FFFFFF] border-t border-black/10">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
        ...
        >
          ...
          <h2 className="font-serif italic font-light tracking-tight text-4xl md:text-5xl lg:text-6xl text-[#0A0A0B] leading-[1.1] mb-6">
            Tell your story. <br />
            <span className="not-italic font-sans font-black uppercase tracking-tighter opacity-90">WE'LL GIVE IT A SCREEN.</span>
          </h2>
          <p className="text-lg text-[#0A0A0B] opacity-70 font-serif italic mb-10 max-w-xl">
          ...
          <div className="grid grid-cols-2 gap-8 mb-12">
            <div>
              <h4 className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#0A0A0B] mb-4">Categories</h4>
              <ul className="text-[#0A0A0B] opacity-60 font-serif text-sm space-y-3">
                <li>Short Fiction</li>
            ...
            <div>
              <h4 className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#0A0A0B] mb-4">Key Dates</h4>
              <ul className="text-[#0A0A0B] opacity-60 font-serif text-sm space-y-3">
          ...
          <button className="px-8 py-4 bg-[#0A0A0B] text-[#FFFFFF] text-[11px] font-bold uppercase tracking-[0.2em] flex items-center justify-center gap-3 hover:bg-zinc-800 transition-colors inline-flex">
        ...
        >
          <div className="aspect-[3/4] bg-[#F5F5F0] border border-black/10 p-2 relative overflow-hidden group">
            ...
            <div className="relative z-10 h-full p-6 flex flex-col justify-between border border-black/10">
              <div className="flex justify-between items-start">
                ...
                <div className="text-right font-mono">
                  ...
                  <p className="text-[11px] font-bold text-[#0A0A0B]">2026</p>
                </div>
              </div>

              <div>
                <h3 className="font-sans font-black text-3xl uppercase tracking-tighter text-[#0A0A0B] mb-4 border-b border-black/20 pb-4">OFFICIAL <br/> SELECTION</h3>
