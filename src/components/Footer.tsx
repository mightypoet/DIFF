export const Footer = () => {
  return (
    <footer className="bg-[#EBE6E0] text-[#0A0A0B] py-16 px-6 relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-16 border-b border-black/10 pb-16">
          <div className="md:w-1/3">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-12 h-12 border-2 border-[#0A0A0B] flex items-center justify-center font-serif text-2xl font-bold italic tracking-tighter text-[#0A0A0B]">D</div>
              <span className="uppercase tracking-[0.3em] text-[10px] font-semibold text-[#0A0A0B]">Darjeeling International<br/>Film Festival</span>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-16">
            <div>
              <h4 className="font-sans font-black uppercase tracking-tighter text-[#0A0A0B] mb-6">Explore</h4>
            ...
            <div>
              <h4 className="font-sans font-black uppercase tracking-tighter text-[#0A0A0B] mb-6">Information</h4>
              <ul className="space-y-4 text-[11px] uppercase tracking-[0.2em] font-medium opacity-70">
            ...
            <div className="col-span-2 md:col-span-1">
              <h4 className="font-sans font-black uppercase tracking-tighter text-[#0A0A0B] mb-6">Connect</h4>
